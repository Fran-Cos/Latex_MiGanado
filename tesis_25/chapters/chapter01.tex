...
El objetivo general del proyecto es desarrollar una aplicaci\'on mobile orientada a la gesti\'on integral del ganado bovino de cr\'ia para la venta, que permita digitalizar y centralizar informaci\'on productiva, sanitaria, reproductiva y econ\'omica de los animales y establecimientos. La soluci\'on buscar\'a mejorar el acceso a los datos por parte de productores, veterinarios, administradores y empleados, incorporando adem\'as herramientas de monitoreo, alertas autom\'aticas, an\'alisis predictivo, detecci\'on de anomal\'ias, asistencia conversacional y proyecciones econ\'omicas.
...
Definidos los objetivos del proyecto, resulta necesario precisar los l\'imites de la entrega y el tipo de producto que se desarrollar\'a. El alcance que se presenta a continuaci\'on delimita las funcionalidades incluidas en el prototipo, las exclusiones consideradas y las condiciones bajo las cuales se evaluar\'a la soluci\'on propuesta.

\section{Alcance}

\subsection{Caracter\'isticas del prototipo funcional}

El alcance comprende el desarrollo de un prototipo funcional de una aplicaci\'on mobile para la gesti\'on integral de establecimientos bovinos dedicados a la cr\'ia para venta. La entrega final del proyecto consistir\'a en una aplicaci\'on operativa con funcionalidades utilizables en un entorno real o representativo del dominio.
...
Las funcionalidades de inteligencia artificial se implementar\'an como componentes preliminares del prototipo. En esta entrega no se define todav\'ia un dataset definitivo para entrenamiento o evaluaci\'on; por lo tanto, el documento explicita esta limitaci\'on y reserva para las pr\'oximas etapas la selecci\'on, curadur\'ia, procedencia, variables y validaci\'on formal de los conjuntos de datos que eventualmente se utilicen. Hasta contar con esa definici\'on, las predicciones y alertas inteligentes se describen como alcance previsto y no como resultados ya validados.
